...
META_URL="https://github.com/vernesong/mihomo/releases/download/Prerelease-Alpha/mihomo-linux-armv7-alpha.gz"
...
echo "SUCCESS: OpenClash meta core (Smart版) injected."
